import{s as g,t as R,P as p,j as n,S as Ce,u as W,b as q,q as J,y as U,R as we,T as z,J as N,w as Y,D as ee,U as te,V as P,Q as F,W as Ee,n as _,X as se,Y as ue,r as B,Z as Se,_ as Te,$ as Be,a0 as G,a1 as pe,a2 as de,F as Z,C as Fe,a3 as Re,A as We,z as _e,a4 as Le,a5 as ze}from"./index-217250fa.js";import{T as De}from"./index.esm-cdad141c.js";import{a as Ie}from"./index.esm-a4ad48c4.js";import{v as Oe,u as Ve}from"./index.esm-670278e3.js";const D=[{value:"de",label:"German"},{value:"en",label:"English"},{value:"uk",label:"Ukrainian"},{value:"ru",label:"Russian"},{value:"es",label:"Spanish"},{value:"fr",label:"French"},{value:"it",label:"Italian"}],I=[{value:.2,label:"Rate: 0.2"},{value:.3,label:"Rate: 0.3"},{value:.4,label:"Rate: 0.4"},{value:.5,label:"Rate: 0.5"},{value:.6,label:"Rate: 0.6"},{value:.7,label:"Rate: 0.7"},{value:.8,label:"Rate: 0.8"},{value:.9,label:"Rate: 0.9"},{value:1,label:"Rate: 1"},{value:1.25,label:"Rate: 1.25"},{value:1.5,label:"Rate: 1.5"}],{colors:Q}=R,Me=g.div`
  display: flex;
  align-items: center;
...
`,et=g.audio`
  ${xe}
`,ke=({el:l,sortByDate:u,setSortByDate:d,setLiColor:$})=>{const i=W(),{user:k}=q(),{activeCluster:w}=J(),{element:f,caption:a}=l,y="$*@",A=(t,e)=>{let r="";return e?(t.trim().endsWith(".")||t.trim().endsWith("!")||t.trim().endsWith("?")||t.endsWith('"')?r=t.trim().replaceAll(",`",";").replaceAll(" `",`${e} `).replaceAll("Mr.","mister").replaceAll("Ms.","miss").replaceAll("Mrs.","missis").replaceAll("...",`__${e}`).replaceAll(".",`.${e}`).replaceAll(",",`,${e}`).replaceAll("!",`!${e}`).replaceAll("?",`?${e}`).replaceAll(":",`:${e}`).replaceAll(`0.${e}`,"0.").replaceAll(`1.${e}`,"1.").replaceAll(`2.${e}`,"2.").replaceAll(`3.${e}`,"3.").replaceAll(`4.${e}`,"4.").replaceAll(`5.${e}`,"5.").replaceAll(`6.${e}`,"6.").replaceAll(`7.${e}`,"7.").replaceAll(`8.${e}`,"8.").replaceAll(`9.${e}`,"9."):r=t.trim()+e,r.includes("[")?r.substring(0,r.indexOf("["))+e:r):t},x=t=>{const e=P({setLiColor:$,divider:y,text:A(f,y),lang:w.lang,rate:w.rate});t.target.blur(),e&&F.error(e)},j=t=>{const e=P({setLiColor:$,divider:y,text:A(a,y),lang:l.lang,rate:k.rate});t.target.blur(),e&&F.error(e)},h=t=>{d(!u),u?F.success("Below is Recent"):F.success("Above is Recent"),t.stopPropagation()},v=t=>{const{_id:e}=w;i(ue(l)),t.currentTarget.closest("li").id!=="active-element"&&i(Y({_id:e,activeEl:l._id}))},b=a.endsWith("mp3"),C=!b&&a.startsWith("http"),s=!b&&!C;return n.jsxs(Je,{onClick:v,children:[n.jsx(ce,{onClick:x,children:f}),n.jsx(Qe,{onClick:h}),b&&n.jsx(et,{controls:!0,src:se(a)}),C&&n.jsx(Ne,{src:se(a)}),s&&n.jsx(ce,{onClick:j,children:a})]})};ke.propTypes={el:p.object,sortByDate:p.bool,setSortByDate:p.func,$active:p.bool,$hovered:p.bool,setLiColor:p.func};const Ae=({el:l,article:u,isForm:d,setIsForm:$})=>{const i=W(),{user:k}=q(),{activeCluster:w}=J(),{_id:f,element:a,caption:y}=l,A=d+24,{register:x,watch:j,setValue:h,handleSubmit:v,setFocus:b}=Ve({mode:"onBlur",defaultValues:{element:a,caption:y}});B.useEffect(()=>{b("element"),u&&a.trim().startsWith("der")?h("element",u+a.replace("der","").trim()+", "):u&&a.trim().startsWith("die")?h("element",u+a.replace("die","").trim()+", "):u&&a.trim().startsWith("das")?h("element",u+a.replace("das","").trim()+", "):u?h("element",u+a+", "):h("element",u+a)},[u,a,b,h]),B.useEffect(()=>{const t=async e=>{e.key==="+"&&(e.preventDefault(),await s(),v(C)()),e.key==="Enter"&&(e.preventDefault(),v(C)()),e.key==="Escape"&&$(!1)};return addEventListener("keydown",t),()=>{removeEventListener("keydown",t)}},[]);const C=t=>{const e=k.lang;let r=t.element.split(/\s+/).join(" ").trim(),o=t.caption.trim();r.endsWith(",")&&(r=r.substring(0,r.length-1)),r.includes("·")&&(r=r.replaceAll(" ·",",").replaceAll("· ",", ")),o.endsWith(",")&&(o=o.substring(0,o.length-1)),i(G({_id:f,lang:e,element:r,caption:o})).then(i(pe())),$(!1)},s=async()=>{const t=j("element"),e={from:w.lang,to:k.lang},r=await de(t,e);h("caption",r)};return n.jsxs(Ke,{onSubmit:v(C),children:[n.jsx(ae,{...x("element"),style:{height:A}}),n.jsxs(Xe,{children:[n.jsx(Ye,{children:n.jsx(Se,{size:"16px"})}),n.jsx(Ze,{type:"button",onClick:()=>$(A),children:n.jsx(Te,{size:"16px"})}),n.jsx(be,{type:"button",onClick:s,children:n.jsx(Be,{size:"16px"})})]}),n.jsx(ae,{...x("caption"),style:{height:A}})]})};Ae.propTypes={el:p.object,article:p.string,isForm:p.oneOfType([p.bool,p.number]),setIsForm:p.func};const ye=({el:l,index:u,length:d,sortByDate:$,setSortByDate:i,translateAll:k,liColor:w,setLiColor:f})=>{const a=W(),{elementTrash:y,activeElement:A}=U(),[x,j]=B.useState(!1),{_id:h,favorite:v,checked:b}=l,C=y.find(T=>T._id===h),[s,t]=B.useState(""),e=()=>{a(G({_id:h,favorite:!v}))},r=()=>{a(G({_id:h,checked:!b}))},o=()=>a(Le(l)),c=T=>{if(x)j(!1);else{const K=T.target.closest("div").clientHeight;j(K)}},E=()=>{s===""&&t("der "),s==="der "&&t("die "),s==="die "&&t("das "),s==="das "&&t("")},S=h===(A==null?void 0:A._id);return n.jsxs(Pe,{id:S?"active-element":null,licolor:w,children:[n.jsxs(Z,{$h:"100%",$p:"0",$fd:"column",children:[n.jsxs(Ge,{$hovered:v,children:[n.jsx("input",{type:"checkbox",name:"favorite",checked:v,onChange:e}),n.jsx(De,{size:"20px"})]}),n.jsxs(He,{$hovered:b,children:[n.jsx("input",{type:"checkbox",name:"checked",checked:b,onChange:r}),n.jsx(Fe,{size:"15px"})]}),x&&d===u+1&&n.jsx(be,{onClick:k,children:n.jsx(Re,{size:"16px"})})]}),x&&n.jsx(Ae,{el:l,article:s,isForm:x,setIsForm:j}),!x&&n.jsx(ke,{el:l,sortByDate:$,setSortByDate:i,setLiColor:f}),n.jsxs(Z,{$h:"100%",$p:"0",$fd:"column",children:[n.jsx(qe,{$hovered:C,onClick:o,children:n.jsx(We,{size:"16px"})}),x&&n.jsx(oe,{onClick:E,children:n.jsx(Ie,{size:"18px"})}),n.jsx(oe,{onClick:c,children:n.jsx(_e,{size:"15px"})})]})]})};ye.propTypes={el:p.object,index:p.number,length:p.number,sortByDate:p.bool,setSortByDate:p.func,translateAll:p.func,liColor:p.string,setLiColor:p.func};const tt=g.ul`
  width: 100%;
  list-style: none;
`,{white:st}=R.colors,nt=()=>{const l=W(),{user:u}=q(),{activeCluster:d}=J(),{allElements:$,elementTrash:i,elementFilter:k}=U(),[w,f]=B.useState(st);let{elementSelect:a}=U();a=a||[];const[y,A]=B.useState(!1),[x,j]=B.useState(!0);B.useEffect(()=>{d&&l(pe({cluster:d._id})).unwrap().then(({result:s})=>{if(!d.activeEl)return;const t=s.elements.find(({_id:e})=>e===d.activeEl);l(ue(t))}).then(()=>{const s=document.getElementById("active-element");(()=>{s==null||s.scrollIntoView({block:"center",behavior:"smooth"})})(),j(!1)})},[]);const h=$.filter(s=>s.cluster===(d==null?void 0:d._id)).sort((s,t)=>s.createdAt.localeCompare(t.createdAt)),b=(()=>{const s=i.map(t=>t._id);return a.includes("trash")?h.filter(t=>s.includes(t._id)):h})().filter(({element:s,caption:t,favorite:e,checked:r})=>{const o=s.toLowerCase().replace("·","").includes(k)||s.toLowerCase().includes(k)||t.toLowerCase().includes(k),c=()=>a.some(S=>["favorite","unfavorite"].includes(S))?a.includes("favorite")?o&&e===!0:o&&e===!1:o;return(()=>a.some(S=>["checked","unchecked"].includes(S))?a.includes("checked")?c()&&r===!0:c()&&r===!1:c())()}).sort(y?(s,t)=>t.createdAt.localeCompare(s.createdAt):(s,t)=>s.createdAt.localeCompare(t.createdAt)),C=async()=>{const s=u.lang;let t=0;await b.forEach(async e=>{if(t>1)return;const{_id:r,element:o}=e;if(!o.startsWith("[")||s!==e.lang){const c={from:d.lang,to:s},E=await de(o,c);l(G({_id:r,lang:s,caption:E})),t=t+1}})};return n.jsxs(n.Fragment,{children:[n.jsxs(tt,{children:[b.map((s,t,e)=>n.jsx(ye,{el:s,index:t,length:e.length,sortByDate:y,setSortByDate:A,translateAll:C,liColor:w,setLiColor:f},s._id)),n.jsx(me,{filtredElements:b,setLiColor:f})]}),x&&n.jsx(ze,{})]})},{s:ie,m:lt}=R.indents,it=()=>n.jsx(Z,{$p:`0 ${lt} ${ie} ${ie}`,children:n.jsx(nt,{})});export{it as default};
