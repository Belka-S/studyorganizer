import{s as $,t as W,P as d,j as n,T as Ae,u as H,b as K,q,y as U,S as je,U as _,K as N,w as ee,D as te,V as se,W as O,Q as B,X as ve,n as F,Y as ne,r as E,Z as Ce,_ as we,$ as P,a0 as ue,a1 as Se,F as Y,C as Ee,a2 as Te,A as Be,z as We,a3 as Fe,J as Re}from"./index-0223e84a.js";import{T as Le}from"./index.esm-0daac89f.js";import{a as _e}from"./index.esm-7c915030.js";import{v as De,u as ze}from"./index.esm-72106f66.js";import{S as Ie}from"./index.esm-cbe2b4ac.js";const D=[{value:"de",label:"German"},{value:"en",label:"English"},{value:"uk",label:"Ukrainian"},{value:"ru",label:"Russian"},{value:"es",label:"Spanish"},{value:"fr",label:"French"},{value:"it",label:"Italian"}],z=[{value:.25,label:"Rate: 0.25"},{value:.5,label:"Rate: 0.5"},{value:.75,label:"Rate: 0.75"},{value:1,label:"Rate: 1"},{value:1.25,label:"Rate: 1.25"},{value:1.5,label:"Rate: 1.5"},{value:1.75,label:"Rate: 1.75"}],{colors:Q}=W,Ve=$.div`
  display: flex;
  align-items: center;
...
`,Ze=$.audio`
  ${be}
`,xe=({el:r,sortByDate:u,setSortByDate:b,setLiColor:x})=>{const{user:p}=K(),{activeCluster:y}=q(),{element:w,caption:g}=r,c="$*@",j=(l,e)=>{let s="";return e?(l.trim().endsWith(".")||l.trim().endsWith("!")||l.trim().endsWith("?")||l.endsWith('"')?s=l.trim().replaceAll(",`",";").replaceAll(" `",`${e} `).replaceAll("Mr.","mister").replaceAll("Ms.","miss").replaceAll("Mrs.","missis").replaceAll("...",`__${e}`).replaceAll(".",`.${e}`).replaceAll(",",`,${e}`).replaceAll("!",`!${e}`).replaceAll("?",`?${e}`).replaceAll(":",`:${e}`).replaceAll(`0.${e}`,"0.").replaceAll(`1.${e}`,"1.").replaceAll(`2.${e}`,"2.").replaceAll(`3.${e}`,"3.").replaceAll(`4.${e}`,"4.").replaceAll(`5.${e}`,"5.").replaceAll(`6.${e}`,"6.").replaceAll(`7.${e}`,"7.").replaceAll(`8.${e}`,"8.").replaceAll(`9.${e}`,"9."):s=l.trim()+e,s.includes("[")?s.substring(0,s.indexOf("[")):s):l},v=l=>{const e=O({setLiColor:x,divider:c,text:j(w,c),lang:y.lang,rate:y.rate});l.target.blur(),e&&B.error(e)},k=l=>{const e=O({setLiColor:x,divider:c,text:j(g,c),lang:r.lang,rate:p.rate});l.target.blur(),e&&B.error(e)},C=l=>{b(!u),u?B.success("Below is Recent"):B.success("Above is Recent"),l.stopImmediatePropagation()},h=g.endsWith("mp3"),A=!h&&g.startsWith("http"),i=!h&&!A;return n.jsxs(He,{children:[n.jsx(ie,{onClick:v,children:w}),n.jsx(qe,{onClick:C}),h&&n.jsx(Ze,{controls:!0,src:ne(g)}),A&&n.jsx(Ye,{src:ne(g)}),i&&n.jsx(ie,{onClick:k,children:g})]})};xe.propTypes={el:d.object,sortByDate:d.bool,setSortByDate:d.func,$active:d.bool,$hovered:d.bool,setLiColor:d.func};const ke=({el:r,article:u,isForm:b,setIsForm:x})=>{const p=H(),{user:y}=K(),{activeCluster:w}=q(),{_id:g,element:c,caption:j}=r,v=b+24,{register:k,watch:C,setValue:h,handleSubmit:A,setFocus:i}=ze({mode:"onBlur",defaultValues:{element:c,caption:j}});E.useEffect(()=>{i("element"),u&&c.trim().startsWith("der")?h("element",u+c.replace("der","").trim()+", "):u&&c.trim().startsWith("die")?h("element",u+c.replace("die","").trim()+", "):u&&c.trim().startsWith("das")?h("element",u+c.replace("das","").trim()+", "):u?h("element",u+c+", "):h("element",u+c)},[u,c,i,h]),E.useEffect(()=>{const s=async t=>{t.key==="+"&&(t.preventDefault(),await e(),A(l)()),t.key==="Enter"&&(t.preventDefault(),A(l)()),t.key==="Escape"&&x(!1)};return addEventListener("keydown",s),()=>{removeEventListener("keydown",s)}},[]);const l=s=>{const t=y.lang;let o=s.element.split(/\s+/).join(" ").trim(),a=s.caption.trim();o.endsWith(",")&&(o=o.substring(0,o.length-1)),o.includes(" ·")&&(o=o.replaceAll(" ·",",")),a.endsWith(",")&&(a=a.substring(0,a.length-1)),p(P({_id:g,lang:t,element:o,caption:a})),x(!1)},e=async()=>{const s=C("element"),t={from:w.lang,to:y.lang},o=await ue(s,t);h("caption",o)};return n.jsxs(Ke,{onSubmit:A(l),children:[n.jsx(ce,{...k("element"),style:{height:v}}),n.jsxs(Je,{children:[n.jsx(Qe,{children:n.jsx(Ce,{size:"16px"})}),n.jsx(Xe,{type:"button",onClick:()=>x(v),children:n.jsx(we,{size:"16px"})}),n.jsx($e,{type:"button",onClick:e,children:n.jsx(Ie,{size:"16px"})})]}),n.jsx(ce,{...k("caption"),style:{height:v}})]})};ke.propTypes={el:d.object,article:d.string,isForm:d.oneOfType([d.bool,d.number]),setIsForm:d.func};const ye=({el:r,index:u,length:b,sortByDate:x,setSortByDate:p,translateAll:y,liColor:w,setLiColor:g})=>{const c=H(),{elementTrash:j,activeElement:v}=U(),[k,C]=E.useState(!1),{_id:h,element:A,favorite:i,checked:l}=r,e=j.find(S=>S._id===h),s=A===v,[t,o]=E.useState("");E.useEffect(()=>{const S=document.getElementById("active-element");(()=>{S==null||S.scrollIntoView({block:"center",behavior:"smooth"})})()},[]);const a=()=>{c(P({_id:h,favorite:!i}))},m=()=>{c(P({_id:h,checked:!l}))},T=()=>c(Fe(r)),L=S=>{if(k)C(!1);else{const Z=S.target.closest("div").clientHeight;C(Z)}},J=()=>{t===""&&o("der "),t==="der "&&o("die "),t==="die "&&o("das "),t==="das "&&o("")};return n.jsxs(Ue,{id:s?"active-element":null,onClick:()=>c(Se(A)),liColor:w,children:[n.jsxs(Y,{$h:"100%",$p:"0",$fd:"column",children:[n.jsxs(Oe,{$hovered:i,children:[n.jsx("input",{type:"checkbox",name:"favorite",checked:i,onChange:a}),n.jsx(Le,{size:"20px"})]}),n.jsxs(Pe,{$hovered:l,children:[n.jsx("input",{type:"checkbox",name:"checked",checked:l,onChange:m}),n.jsx(Ee,{size:"15px"})]}),k&&b===u+1&&n.jsx($e,{onClick:y,children:n.jsx(Te,{size:"16px"})})]}),k&&n.jsx(ke,{el:r,article:t,isForm:k,setIsForm:C}),!k&&n.jsx(xe,{el:r,sortByDate:x,setSortByDate:p,setLiColor:g}),n.jsxs(Y,{$h:"100%",$p:"0",$fd:"column",children:[n.jsx(Ge,{$hovered:e,onClick:T,children:n.jsx(Be,{size:"16px"})}),k&&n.jsx(ae,{onClick:J,children:n.jsx(_e,{size:"18px"})}),n.jsx(ae,{onClick:L,children:n.jsx(We,{size:"15px"})})]})]})};ye.propTypes={el:d.object,index:d.string,length:d.string,sortByDate:d.bool,setSortByDate:d.func,translateAll:d.func,liColor:d.string,setLiColor:d.func};const Ne=$.ul`
  width: 100%;
  list-style: none;
`,{white:et}=W.colors,tt=()=>{const r=H(),{user:u}=K(),{activeCluster:b}=q(),{allElements:x,elementTrash:p,elementFilter:y}=U(),[w,g]=E.useState(et);let{elementSelect:c}=U();c=c||[];const[j,v]=E.useState(!1);E.useEffect(()=>{r(Re())},[r]);const k=x.filter(i=>i.cluster===(b==null?void 0:b._id)).sort((i,l)=>i.createdAt.localeCompare(l.createdAt)),h=(()=>{const i=p.map(l=>l._id);return c.includes("trash")?k.filter(l=>i.includes(l._id)):k})().filter(({element:i,caption:l,favorite:e,checked:s})=>{const t=i.toLowerCase().replace("·","").includes(y)||i.toLowerCase().includes(y)||l.toLowerCase().includes(y),o=c.includes("favorite")?t&&e===!0:t;return c.some(a=>["checked","unchecked"].includes(a))?c.includes("checked")?o&&s===!0:o&&s===!1:o}).sort(j?(i,l)=>l.createdAt.localeCompare(i.createdAt):(i,l)=>i.createdAt.localeCompare(l.createdAt)),A=async()=>{const i=u.lang;let l=0;await h.forEach(async e=>{if(l>1)return;const{_id:s,element:t}=e;if(!t.startsWith("[")||i!==e.lang){const o={from:b.lang,to:i},a=await ue(t,o);r(P({_id:s,lang:i,caption:a})),l=l+1}})};return n.jsxs(Ne,{children:[h.map((i,l,e)=>n.jsx(ye,{el:i,index:l,length:e.length,sortByDate:j,setSortByDate:v,translateAll:A,liColor:w,setLiColor:g},i._id)),n.jsx(he,{filtredElements:h,setLiColor:g})]})},{s:pe,m:st}=W.indents,ct=()=>n.jsx(Y,{$p:`0 ${st} ${pe} ${pe}`,children:n.jsx(tt,{})});export{ct as default};
