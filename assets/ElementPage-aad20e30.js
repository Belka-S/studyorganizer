import{s as p,t as T,u as L,j as t,T as xe,U as ae,P as d,b as le,q as P,y as H,S as ge,V as W,K as M,w as J,D as Q,W as X,X as G,Q as A,Y as $e,n as F,Z as Y,_ as ve,r as S,$ as ye,a0 as ke,a1 as O,a2 as je,F as q,C as Ce,A as we,z as Ee,a3 as Se,J as Te}from"./index-55babd0d.js";import{T as Ae}from"./index.esm-ac20be37.js";import{a as Be}from"./index.esm-ad626842.js";import{v as Le,u as Fe}from"./index.esm-f781600e.js";import{S as Re}from"./index.esm-01ed092c.js";const z=[{value:"de",label:"German"},{value:"en",label:"English"},{value:"uk",label:"Ukrainian"},{value:"ru",label:"Russian"},{value:"es",label:"Spanish"},{value:"fr",label:"French"},{value:"it",label:"Italian"}],D=[{value:.25,label:"Rate: 0.25"},{value:.5,label:"Rate: 0.5"},{value:.75,label:"Rate: 0.75"},{value:1,label:"Rate: 1"},{value:1.25,label:"Rate: 1.25"},{value:1.5,label:"Rate: 1.5"},{value:1.75,label:"Rate: 1.75"}],{colors:U}=T,We=p.div`
  display: flex;
  align-items: center;
...
`,ze=()=>{const s=L(),r=()=>{document.querySelectorAll('button[style="font-size: 32px;"]').forEach(x=>x.removeAttribute("style")),s(ae(null))};return t.jsx(We,{onClick:r,children:t.jsx(xe,{size:"26px"})})},{background:Z,backgroundHoverd:_,white:I,borderLight:V}=T.colors,{button:N}=T.shadows,ie=({filtredElements:s,setLiColor:r})=>{const b=L(),{user:x}=le(),{activeCluster:l}=P(),{activeElement:h}=H(),g=({value:n})=>{b(J({_id:l._id,lang:n})).unwrap().then(e=>b(Q(e.result.cluster)))},$=({value:n})=>{b(J({_id:l._id,rate:n})).unwrap().then(e=>b(Q(e.result.cluster)))},i=({value:n})=>{const e=new FormData;e.append("lang",n),b(X(e))},j=({value:n})=>{const e=new FormData;e.append("rate",n),b(X(e))},m=n=>{r(Z);let e="";const o="$*@",k=s.findIndex(a=>a.element===h),u=s.splice(k===-1?0:k);for(let a=0;a<u.length;a+=1){const{element:c}=u[a];c.endsWith(".")||c.endsWith("!")||c.endsWith("?")?e+=c.replaceAll(".",o).replaceAll("!",o).replaceAll("?",o).replaceAll(",",o):e+=c.replaceAll(".",o)+o}const f=G({setLiColor:r,divider:o,text:e,lang:l.lang,rate:l.rate});n.target.blur(),f&&A.error(f)},C=n=>{r(Z);let e="";const o="$*@",k=s.findIndex(a=>a.element===h),u=s.splice(k===-1?0:k);for(let a=0;a<u.length;a+=1){const{element:c,caption:v,lang:w}=u[a];e+=c+`@±@${w}`+v+o}const f=$e({setLiColor:r,divider:o,text:e,lang:l.lang,rate:l.rate});n.target.blur(),f&&A.error(f)};return t.jsxs(ge,{$m:"0",$cg:"8px",$ai:"center",$gtc:"2fr 2fr 1fr .3fr 1fr 2fr 2fr",children:[t.jsx(W,{options:z,defaultValue:z.find(n=>n.value===(l==null?void 0:l.lang)),onChange:g,placeholder:"Language...",$ol:_,$b:I,$bh:V}),t.jsx(W,{options:D,defaultValue:D.find(n=>n.value==(l==null?void 0:l.rate)),onChange:$,placeholder:"Rate...",$ol:_,$b:I,$bh:V}),t.jsx(M,{onClick:m,$s:"m",$bs:N,children:"play"}),t.jsx(ze,{}),t.jsx(M,{onClick:C,$s:"m",$bs:N,children:"all"}),t.jsx(W,{options:z,defaultValue:z.find(n=>n.value===x.lang),onChange:i,$ol:_,$b:I,$bh:V}),t.jsx(W,{options:D,defaultValue:D.find(n=>n.value==x.rate),onChange:j,$ol:_,$b:I,$bh:V})]})};ie.propTypes={filtredElements:d.object,setLiColor:d.func};const{colors:y,shadows:ee,indents:te}=T,De=F`
  margin-bottom: 7px;
  padding-block: ${te.xs};
