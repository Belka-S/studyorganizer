...
`,qr=U.iframe`
  ${Yr}
`,nt=({el:e,handleEdit:t,setRecording:n,setTranslation:a})=>{const o=_.useRef(null),c=_.useRef(null),r=_.useRef(null),s=ae(),{user:h}=de(),{activeCluster:k}=te(),[d,g]=_.useState(""),{_id:y,element:f,caption:$}=e,{register:x,watch:u,setValue:b,handleSubmit:m,setFocus:A}=Hn({mode:"onBlur",defaultValues:{element:f,caption:$}});_.useEffect(()=>{b("caption",$)},[$,b]);const{ref:v,...i}=x("element"),{ref:T,...E}=x("caption"),I=[o.current,c.current,r.current],F=[u("caption"),u("element")];Xn(I,F),_.useEffect(()=>{A("element"),d&&f.trim().startsWith("der")?b("element",d+f.replace("der","").trim()+", "):d&&f.trim().startsWith("die")?b("element",d+f.replace("die","").trim()+", "):d&&f.trim().startsWith("das")?b("element",d+f.replace("das","").trim()+", "):d?b("element",d+f+", "):b("element",d+f)},[d,f,A,b]);const W=_.useCallback(C=>{const O=h.lang;let B=C.caption.trim(),D=qe(C.element,k.lang).split(/\s+/).join(" ").replaceAll(`
`," ").trim();D=De(D,","),B=De(B,","),h.lang.includes("en")&&k.lang.includes("de")&&![".","!","?",'"'].includes(D.at(-1))&&(D.includes("hat")||D.includes("ist"))&&D.split(`
`)[0].split(/,\s+/)[0].endsWith("n")&&(B=B.split(/,\s+/).map(l=>l.startsWith("to ")?l:`to ${l}`).join(", ")),s(y?Ve({_id:y,lang:O,element:D,caption:B}):jt({...e,element:D,caption:B})).then(s(It({clusterId:k._id}))),!y&&B&&(k.sortBy?Qe():Ze(),n(""),a("")),t(!0)},[y,k._id,k.lang,k.sortBy,s,e,t,n,a,h.lang]),M=()=>{d===""&&g("der "),d==="der "&&g("die "),d==="die "&&g("das "),d==="das "&&g("")},R=_.useCallback(async C=>{const O=u("element"),B=qe(O,k.lang).split(/\s+/).join(" ").replaceAll(`
`," ").trim(),D={from:k.lang,to:h.lang},K=await Ie(B,D,C);b("caption",K)},[k.lang,b,h.lang,u]),j=document.querySelector("#modal");return _.useEffect(()=>{const C=async O=>{O==null||O.currentTarget.blur(),j.children.length===0&&(O.code==="NumpadAdd"||O.key==="F2")&&(O.preventDefault(),await R(h.engine),m(W)()),(O.key==="Enter"||O.key==="§"||j.children.length>0&&O.key==="F2")&&(O.preventDefault(),m(W)()),O.key==="Escape"&&(O.preventDefault(),t(!0)),O.code==="AltRight"&&o.current.focus()};return addEventListener("keydown",C),()=>{removeEventListener("keydown",C)}},[t,m,j.children.length,W,R,h.engine]),S.jsxs(Kr,{onSubmit:m(W),children:[S.jsx(xt,{...i,name:"element",ref:C=>{v(C),o.current=C}}),S.jsxs(Gr,{ref:r,children:[S.jsx(Hr,{type:"button",onClick:M,children:S.jsx(xn,{size:"18px"})}),S.jsx(At,{type:"button",onClick:()=>R("google"),children:S.jsx(An,{size:"16px"})}),S.jsx(At,{type:"button",onClick:()=>R("deepl"),children:S.jsx(En,{size:"18px"})}),S.jsx(Vr,{children:S.jsx(Cn,{size:"16px"})})]}),S.jsx(xt,{...E,name:"caption",ref:C=>{T(C),c.current=C}})]})};nt.propTypes={el:N.object,handleEdit:N.func,setRecording:N.func,setTranslation:N.func};const{button:Xr}=V.shadows,{m:Jr}=V.indents,Yt=({className:e})=>{const{user:t}=de(),[n,a]=_.useState(!1),{activeCluster:o}=te(),[c,r]=_.useState(""),[s,h]=_.useState(""),{transcript:k,listening:d,resetTranscript:g}=be.useSpeechRecognition(),{isMicrophoneAvailable:y}=be.useSpeechRecognition(),{browserSupportsSpeechRecognition:f}=be.useSpeechRecognition(),$=c.endsWith(", ")||c.replace(/[a-z]$/,"*#").endsWith("*#")?k.replace(/^./,v=>` ${v}`):k.replace(/^./,v=>v.toUpperCase()),x=`${c}${$}`,u=wt(x,St),b=(v,i)=>v.trim().endsWith(i)?`${v.trim()} `:`${v.trim()}${i} `;_.useEffect(()=>{if(!n)return;const v=[".","?","!",","],i=T=>{if(v.includes(T.key)){T.preventDefault();const E=b(u,T.key);r(E),g()}if(T.key==="Backspace"){T.preventDefault();const E=window.getSelection().toString();if(window.getSelection().deleteFromDocument(),E){const I=u.replace(E,"");r(I)}else{const I=u.length-1,F=u.substring(0,I);r(F)}g()}if(T.key==="Space"){T.preventDefault();const E=u+" ";r(E),g()}};return addEventListener("keydown",i),()=>{removeEventListener("keydown",i)}},[n,d,u,g]),_.useEffect(()=>{const v=async i=>{const T=i.key==="F1"||i.key==="r"&&i.metaKey&&!i.altKey&&!i.shiftKey;if(d||T&&(i.preventDefault(),a(!0),ye.startListening({language:o.lang,continuous:!0})),d&&T){i.preventDefault(),ye.stopListening();const E=u.at(-1),I=!E||["!"].includes(E)?u:b(u,"."),F=await Ie(wt(I,St),{from:o.lang,to:t.lang},t.engine);r(I),h(F),g()}};return addEventListener("keydown",v),()=>{removeEventListener("keydown",v)}},[o==null?void 0:o.lang,n,d,u,g,t.engine,t.lang]);const m=_.useCallback(()=>{ye.stopListening(),a(!1),r(""),h(""),g()},[g]);if(_.useEffect(()=>{const v=i=>{if(i.key==="Escape"||i.key==="Enter"||i.key==="§")return i.preventDefault(),m()};return addEventListener("keyup",v),()=>{removeEventListener("keyup",v)}},[m]),!f||!y)return;const A=async v=>{if(v==null||v.currentTarget.blur(),!d)a(!0),ye.startListening({language:o.lang,continuous:!0});else{ye.stopListening();const i=u.at(-1),T=!i||["!"].includes(i)?u:b(u,"."),E={from:o.lang,to:t.lang},I=await Ie(T,E,t.engine);r(T),h(I),g()}};return S.jsxs("div",{className:Ir(e,!n&&"hidden"),children:[S.jsxs(pe,{onClick:A,$s:"m",$round:!0,$bs:Xr,children:[!d&&S.jsx(_n,{size:18})," ",d&&S.jsx(Ln,{size:18,fill:V.colors.error})]}),n&&S.jsx(jn,{$x:`left: ${Jr}`,$y:"top: 50%",$bd:d?"listening":"none",btn:!0,onClick:m,children:S.jsx(nt,{el:{cluster:o._id,element:u.trim(),caption:s.trim(),favorite:!0,checked:u.split(/\s+/).length<20},handleEdit:a,setRecording:r,setTranslation:h})})]})};Yt.propTypes={className:N.string};const{background:Ue}=V.colors,{button:Ct}=V.shadows,{s:_t,m:Qr}=V.indents,qt=({className:e,filtredElements:t,setLiColor:n})=>{const{user:a}=de(),{activeCluster:o}=te(),{activeElement:c}=oe(),[r,s]=_.useState(null);if(_.useEffect(()=>{const u=window.speechSynthesis.getVoices();Array.isArray(u)&&u.length>0&&s(u),"onvoiceschanged"in window.speechSynthesis&&(window.speechSynthesis.onvoiceschanged=()=>{const b=window.speechSynthesis.getVoices();s(b)})},[]),!Array.isArray(r)||r.length===0)return;const h=u=>{if(!u.length)return;let b="",m=0;const A=u.reduce((v,i)=>(v[i.lang]||(v[i.lang]=0),v[i.lang]+=1,v),{});for(const v in A)A[v]>m&&(m=A[v],b=v);return b},k=t.length?h(t):a.lang,d=(u,b)=>u.replaceAll(", `",`;${b} `).replaceAll(" `",`${b} `).replaceAll(",`",";"),g=({text:u,playList:b,divider:m})=>{let A="";for(let v=0;v<b.length;v+=1){let i=b[v][u];const T=`@±@${b[v].lang}${m}`;[".","!","?",'"'].includes(i.at(-1))?(A+=d(i,m).replaceAll("Mr.","misteR").replaceAll("Ms.","misS").replaceAll("Mrs.","missiS").replaceAll("...",u!=="caption"?`__${m}`:`__${T}`).replaceAll(".",u!=="caption"?`.${m}`:`.${T}`).replaceAll(",",u!=="caption"?`,${m}`:`,${T}`).replaceAll("!",u!=="caption"?`!${m}`:`!${T}`).replaceAll("?",u!=="caption"?`?${m}`:`?${T}`),o.lang.includes("de")&&(A=A.replaceAll(`0.${m}`,"0.").replaceAll(`1.${m}`,"1.").replaceAll(`2.${m}`,"2.").replaceAll(`3.${m}`,"3.").replaceAll(`4.${m}`,"4.").replaceAll(`5.${m}`,"5.").replaceAll(`6.${m}`,"6.").replaceAll(`7.${m}`,"7.").replaceAll(`8.${m}`,"8.").replaceAll(`9.${m}`,"9."))):b[v].element.startsWith("[")||(u==="caption"&&(i.includes(" [")&&(i=i.substring(0,i.indexOf(" ["))),i=`${i}@±@${b[v].lang}`),A+=i+m)}return A},y=r,f=u=>{u==null||u.currentTarget.blur(),n(Ue);const b="$*@",m=t.findIndex(i=>i.element===c.element),A=t.splice(m===-1?0:m),v=Pe({setLiColor:n,divider:b,voices:y,text:g({text:"element",playList:A,divider:b}),lang:o.lang,rate:o.rate});v&&ee.error(v)},$=u=>{u==null||u.currentTarget.blur();const b="$*@";n(Ue);const m=t.findIndex(i=>i.element===c.element),A=t.splice(m===-1?0:m),v=Pe({setLiColor:n,divider:b,voices:y,text:g({text:"caption",playList:A,divider:b}),lang:k,rate:a.rate});v&&ee.error(v)},x=u=>{u==null||u.currentTarget.blur(),n(Ue);let b="";const m="$*@",A=t.findIndex(T=>T.element===c.element),v=t.splice(A===-1?0:A);for(let T=0;T<v.length;T+=1){const{element:E,caption:I,lang:F}=v[T];if(!E.startsWith("[")){const W=d(E,""),M=I.includes(" [")?I.substring(0,I.indexOf(" [")):d(I,"");b+=W+`@±@${F}`+M+m}}const i=Pn({setLiColor:n,divider:m,voices:y,text:b,lang:o.lang,rate:a.rate});i&&ee.error(i)};return S.jsxs(Je,{className:e,$m:`${_t} ${Qr}`,$pos:"fixed",$side:"right",$high:"bottom",$gtc:" 1fr 1fr 0.5fr 1fr",$cg:_t,children:[S.jsx(Yt,{}),S.jsx(pe,{onClick:f,$s:"m",$round:!0,$bs:Ct,children:(o==null?void 0:o.lang.at(0).toUpperCase())+(o==null?void 0:o.lang.substring(1))}),S.jsx(Bt,{onClick:x}),S.jsx(pe,{onClick:$,$s:"m",$round:!0,$bs:Ct,children:(k==null?void 0:k.at(0).toUpperCase())+(k==null?void 0:k.substring(1))})]})};qt.propTypes={className:N.string,filtredElements:N.array,setLiColor:N.func};const{colors:Ge}=V,Zr=U.button`
  position: absolute;
  top: 0;
  left: 0;
  margin: 0;
...
`,Jt=({src:e,accessToken:t,expiresIn:n})=>{const a=ae(),o=_.useRef(),[c,r]=_.useState("dump"),s=On({onSuccess:d=>{const{access_token:g,expires_in:y}=d,f={accessToken:g,expiresIn:y*1e3+Date.now()};a(In(f)),h(g)},onError:d=>ee.error(d.message),scope:Gn}),h=async d=>{try{const g=await Dn.get(e,{responseType:"blob",headers:{Authorization:`Bearer ${d}`}}).then(f=>f.data),y=URL.createObjectURL(g);r(y)}catch(g){ee.error(g.message)}},k=Date.now()<n;return S.jsx(ri,{ref:o,src:e.endsWith(".mp3")?e:c,onError:()=>{!k&&s(),k&&h(t)},onPause:d=>d.target.blur(),onEnded:d=>d.target.blur(),controls:!0})};Jt.propTypes={src:N.string,accessToken:N.string,expiresIn:N.number};const Qt=({el:e,setLiColor:t,editCount:n,selectMode:a})=>{var m,A;const o=ae(),{user:c}=de(),{activeCluster:r}=te(),{activeElement:s}=oe(),h=e.element,k=Mn(e.caption),[d,g]=_.useState(()=>{var v;return!((v=k.file)!=null&&v.endsWith(".mp3"))}),y="$*@",f=_.useCallback((v,i)=>{let T="";return i?([".","!","?",'"'].includes(v.trim().at(-1))?(T=v.trim().replaceAll(", `",`;${i} `).replaceAll(" `",`${i} `).replaceAll(",`",";").replaceAll("Mr.","misteR").replaceAll("Ms.","misS").replaceAll("Mrs.","missiS").replaceAll("...",`__${i}`).replaceAll(".",`.${i}`).replaceAll(",",`,${i}`).replaceAll("!",`!${i}`).replaceAll("?",`?${i}`),r.lang.includes("de")&&(T=T.replaceAll(`0.${i}`,"0.").replaceAll(`1.${i}`,"1.").replaceAll(`2.${i}`,"2.").replaceAll(`3.${i}`,"3.").replaceAll(`4.${i}`,"4.").replaceAll(`5.${i}`,"5.").replaceAll(`6.${i}`,"6.").replaceAll(`7.${i}`,"7.").replaceAll(`8.${i}`,"8.").replaceAll(`9.${i}`,"9."))):T=v.trim()+i,T.includes("[")?T.substring(0,T.indexOf("["))+i:T):v},[r.lang]),$=_.useCallback(v=>{if(v==null||v.currentTarget.blur(),a||h.startsWith("["))return;const i=Pe({setLiColor:t,divider:y,voices:window.speechSynthesis.getVoices(),text:f(h,y),lang:r.lang,rate:r.rate});i&&ee.error(i)},[r.lang,r.rate,h,f,a,t]),x=_.useCallback(v=>{if(v==null||v.currentTarget.blur(),a)return;const i=Pe({setLiColor:t,divider:y,voices:window.speechSynthesis.getVoices(),text:f(k.text,y),lang:e.lang,rate:c.rate});i&&ee.error(i)},[k.text,e.lang,f,a,t,c.rate]);_.useEffect(()=>{if(n>0||e._id!==(s==null?void 0:s._id))return;const v=i=>{i.key==="ArrowLeft"&&!i.metaKey&&!i.altKey&&!i.shiftKey&&(i.preventDefault(),$()),i.key==="ArrowRight"&&!i.metaKey&&!i.altKey&&!i.shiftKey&&(i.preventDefault(),x())};return addEventListener("keydown",v),()=>{removeEventListener("keydown",v)}},[s==null?void 0:s._id,n,e._id,x,$]);const u=()=>{if(a)return;if(h.startsWith("[")){g(!d);return}const{_id:v,activeElementId:i}=r;o(Oe(e)),i!==e._id&&o(Le({_id:v,activeElementId:e._id})).unwrap().then(T=>o(je(T.result.cluster)))},b=v=>{v.stopPropagation();const{_id:i,sortBy:T}=r;o(Le({_id:i,sortBy:!T})).unwrap().then(E=>o(je(E.result.cluster)))};return S.jsxs(Fr,{onClick:u,children:[S.jsx(Et,{onClick:$,$mode:`${a}`,children:h}),S.jsx(Ur,{onClick:b}),k.text&&S.jsx(Et,{onClick:x,$mode:`${a}`,children:k.text}),d&&!k.text&&S.jsx(qr,{src:k.link}),!d&&!k.text&&S.jsx(Jt,{src:k.file,accessToken:(m=c.googleToken)==null?void 0:m.accessToken,expiresIn:(A=c.googleToken)==null?void 0:A.expiresIn})]})};Qt.propTypes={el:N.object,setLiColor:N.func,editCount:N.number,selectMode:N.bool};const Zt=({el:e,liColor:t,setLiColor:n,editCount:a,setEditCount:o,selectMode:c})=>{const r=ae(),s=_.useRef(null),{activeCluster:h}=te(),{elementTrash:k,activeElement:d,allElements:g}=oe(),[y,f]=_.useState(!1),{_id:$,favorite:x,checked:u}=e,b=k.find(I=>I._id===$),m=$===(d==null?void 0:d._id),A=I=>{f(!I),o(I?a-1:a+1)},v=document.querySelector("#modal");_.useEffect(()=>{if(!m)return;const{sortBy:I}=h,F=d.element.startsWith("["),W=M=>{if(M.key==="F2"&&!F&&v.children.length===0&&(M.preventDefault(),f(!y),o(y?a-1:a+1)),!(a>0)){if(M.key==="ArrowDown"&&!M.metaKey&&!M.altKey&&!M.shiftKey){M.preventDefault();const R=g.findIndex(({_id:j})=>j===(d==null?void 0:d._id));r(Oe(g[I?R-1:R+1])),Ye(s.current.nextElementSibling)}if(M.key==="ArrowUp"&&!M.metaKey&&!M.altKey&&!M.shiftKey){M.preventDefault();const R=g.findIndex(({_id:j})=>j===(d==null?void 0:d._id));r(Oe(g[I?R+1:R-1])),Ye(s.current.previousElementSibling)}M.altKey&&M.key==="ArrowDown"&&!M.metaKey&&!M.shiftKey&&(M.preventDefault(),Ze()),M.altKey&&M.key==="ArrowUp"&&!M.metaKey&&!M.shiftKey&&(M.preventDefault(),Qe())}};return addEventListener("keydown",W),()=>{removeEventListener("keydown",W)}},[h,d==null?void 0:d._id,d==null?void 0:d.element,g,r,a,m,y,v.children.length,o]);const i=()=>{r(Ve({_id:$,favorite:!x}))},T=()=>{r(Ve({_id:$,checked:!u}))},E=()=>r(Wn(e));return S.jsxs(Mr,{id:m?"active-element":null,$licolor:t,ref:s,children:[S.jsxs(He,{$h:"100%",$p:"0",$fd:"column",children:[S.jsxs(zr,{$hovered:x,children:[S.jsx("input",{type:"checkbox",name:"favorite",checked:x,onChange:i}),S.jsx(Un,{size:"20px"})]}),S.jsxs(Nr,{$hovered:u,children:[S.jsx("input",{type:"checkbox",name:"checked",checked:u,onChange:T}),S.jsx(zn,{size:"15px"})]})]}),y&&S.jsx(nt,{el:e,handleEdit:A}),!y&&S.jsx(Qt,{el:e,setLiColor:n,editCount:a,selectMode:c}),S.jsxs(He,{$h:"100%",$p:"0",$fd:"column",children:[S.jsx(Br,{$hovered:b,onClick:E,children:S.jsx(Nn,{size:"16px"})}),S.jsx(Wr,{onClick:()=>A(y),children:S.jsx(Bn,{size:"15px"})})]})]})};Zt.propTypes={el:N.object,liColor:N.string,setLiColor:N.func,editCount:N.number,setEditCount:N.func,selectMode:N.bool};const ii=U.ul`
  width: 100%;
  list-style: none;
...
`,{white:si}=V.colors,oi=()=>{const e=ae(),{activeCluster:t}=te(),{allElements:n,activeElement:a,elementTrash:o,elementFilter:c,isLoading:r}=oe(),[s,h]=_.useState(si),[k,d]=_.useState(0),[g,y]=_.useState(!1),{ref:f,inView:$,entry:x}=cr({initialInView:!0,rootMargin:`0px 0px ${window.innerHeight/2}px 0px`});_.useEffect(()=>{if(!t)return;const i=()=>{const T=document.getElementById("active-element");T&&Ye(T)};(a==null?void 0:a._id)===t.activeElementId?i():e(It({clusterId:t._id})).unwrap().then(({result:T})=>{if(!t.activeElementId)return;const E=T.elements.find(({_id:I})=>I===t.activeElementId);e(Oe(E))}).then(()=>i())},[]),_.useEffect(()=>{const i=E=>{E.altKey&&y(!0)},T=E=>{E.altKey||y(!1)};return addEventListener("keyup",T),addEventListener("keydown",i),()=>{removeEventListener("keydown",i),removeEventListener("keyup",T)}},[g,y]);let{elementSelect:u}=oe();u=u||[];const b=n.filter(i=>i.clusterId===(t==null?void 0:t._id)).sort((i,T)=>i.createdAt.localeCompare(T.createdAt)),A=(()=>{const i=o.map(T=>T._id);return u.includes("trash")?b.filter(T=>i.includes(T._id)):b})().filter(({element:i,caption:T,favorite:E,checked:I})=>{const F=i.toLowerCase().replace("·","").includes(c)||i.toLowerCase().includes(c)||T.toLowerCase().includes(c),W=u.includes("wordlist")?F&&Fn(i):F,M=()=>u.some(j=>["favorite","unfavorite"].includes(j))?u.includes("favorite")?W&&E===!0:W&&E===!1:W;return(()=>u.some(j=>["checked","unchecked"].includes(j))?u.includes("checked")?M()&&I===!0:M()&&I===!1:M())()}).sort(t!=null&&t.sortBy?(i,T)=>T.createdAt.localeCompare(i.createdAt):(i,T)=>i.createdAt.localeCompare(T.createdAt)),v=window.innerHeight<(x==null?void 0:x.target.getBoundingClientRect().y)+(x==null?void 0:x.target.getBoundingClientRect().height)*1.5;return S.jsxs(S.Fragment,{children:[S.jsxs(ii,{id:"element-list",children:[A.map(i=>S.jsx(Zt,{el:i,liColor:s,setLiColor:h,editCount:k,setEditCount:d,selectMode:g},i._id)),!r&&S.jsxs("div",{ref:f,children:[S.jsx(zt,{}),S.jsx(Nt,{className:$&&v?"bar-up":"bar-down"}),S.jsx(qt,{className:$&&v?"bar-up":"bar-down",filtredElements:A,setLiColor:h})]})]}),S.jsxs(Xt,{children:[S.jsx("span",{children:"Translate"})," ",S.jsx(Pt,{size:18})]}),r&&S.jsx(Kn,{})]})},{s:Lt,m:ai}=V.indents,fi=()=>S.jsx(He,{$p:`0 ${ai} ${Lt} ${Lt}`,children:S.jsx(oi,{})});export{fi as default};
