...
`,Ze=$.audio`
  ${xe}
`,ke=({el:l,sortByDate:u,setSortByDate:b,setLiColor:x})=>{const{user:p}=q(),{activeCluster:k}=_(),{element:w,caption:g}=l,i="$*@",j=(r,e)=>{let t="";return e?(r.trim().endsWith(".")||r.trim().endsWith("!")||r.trim().endsWith("?")||r.endsWith('"')?t=r.trim().replaceAll(",`",";").replaceAll(" `",`${e} `).replaceAll("Mr.","mister").replaceAll("Ms.","miss").replaceAll("Mrs.","missis").replaceAll("...",`__${e}`).replaceAll(".",`.${e}`).replaceAll(",",`,${e}`).replaceAll("!",`!${e}`).replaceAll("?",`?${e}`).replaceAll(":",`:${e}`).replaceAll(`0.${e}`,"0.").replaceAll(`1.${e}`,"1.").replaceAll(`2.${e}`,"2.").replaceAll(`3.${e}`,"3.").replaceAll(`4.${e}`,"4.").replaceAll(`5.${e}`,"5.").replaceAll(`6.${e}`,"6.").replaceAll(`7.${e}`,"7.").replaceAll(`8.${e}`,"8.").replaceAll(`9.${e}`,"9."):t=r.trim()+e,t.includes("[")?t.substring(0,t.indexOf("[")):t):r},v=r=>{const e=P({setLiColor:x,divider:i,text:j(w,i),lang:k.lang,rate:k.rate});r.target.blur(),e&&B.error(e)},C=r=>{const e=P({setLiColor:x,divider:i,text:j(g,i),lang:l.lang,rate:p.rate});r.target.blur(),e&&B.error(e)},y=r=>{b(!u),u?B.success("Below is Recent"):B.success("Above is Recent"),r.stopImmediatePropagation()},h=g.endsWith("mp3"),A=!h&&g.startsWith("http"),a=!h&&!A;return n.jsxs(He,{children:[n.jsx(ie,{onClick:v,children:w}),n.jsx(qe,{onClick:y}),h&&n.jsx(Ze,{controls:!0,src:ne(g)}),A&&n.jsx(Ye,{src:ne(g)}),a&&n.jsx(ie,{onClick:C,children:g})]})};ke.propTypes={el:d.object,sortByDate:d.bool,setSortByDate:d.func,$active:d.bool,$hovered:d.bool,setLiColor:d.func};const Ae=({el:l,article:u,isForm:b,setIsForm:x})=>{const p=K(),{user:k}=q(),{activeCluster:w}=_(),{_id:g,element:i,caption:j}=l,v=b+24,{register:C,watch:y,setValue:h,handleSubmit:A,setFocus:a}=ze({mode:"onBlur",defaultValues:{element:i,caption:j}});E.useEffect(()=>{a("element"),u&&i.trim().startsWith("der")?h("element",u+i.replace("der","").trim()+", "):u&&i.trim().startsWith("die")?h("element",u+i.replace("die","").trim()+", "):u&&i.trim().startsWith("das")?h("element",u+i.replace("das","").trim()+", "):u?h("element",u+i+", "):h("element",u+i)},[u,i,a,h]),E.useEffect(()=>{const t=async s=>{s.key==="+"&&(s.preventDefault(),await e(),A(r)()),s.key==="Enter"&&(s.preventDefault(),A(r)()),s.key==="Escape"&&x(!1)};return addEventListener("keydown",t),()=>{removeEventListener("keydown",t)}},[]);const r=t=>{const s=k.lang;let c=t.element.split(/\s+/).join(" ").trim(),o=t.caption.trim();c.endsWith(",")&&(c=c.substring(0,c.length-1)),c.includes("·")&&(c=c.replaceAll(" ·",",").replaceAll("·",",")),o.endsWith(",")&&(o=o.substring(0,o.length-1)),p(G({_id:g,lang:s,element:c,caption:o})).then(p(ue())),x(!1)},e=async()=>{const t=y("element"),s={from:w.lang,to:k.lang},c=await de(t,s);h("caption",c)};return n.jsxs(Ke,{onSubmit:A(r),children:[n.jsx(ce,{...C("element"),style:{height:v}}),n.jsxs(Ne,{children:[n.jsx(Qe,{children:n.jsx(we,{size:"16px"})}),n.jsx(Xe,{type:"button",onClick:()=>x(v),children:n.jsx(Ee,{size:"16px"})}),n.jsx(be,{type:"button",onClick:e,children:n.jsx(Ie,{size:"16px"})})]}),n.jsx(ce,{...C("caption"),style:{height:v}})]})};Ae.propTypes={el:d.object,article:d.string,isForm:d.oneOfType([d.bool,d.number]),setIsForm:d.func};const ye=({el:l,index:u,length:b,sortByDate:x,setSortByDate:p,translateAll:k,liColor:w,setLiColor:g})=>{const i=K(),{activeCluster:j}=_(),{elementTrash:v,activeElement:C}=O(),[y,h]=E.useState(!1),{_id:A,favorite:a,checked:r}=l,e=v.find(T=>T._id===A),[t,s]=E.useState(""),c=()=>{i(G({_id:A,favorite:!a}))},o=()=>{i(G({_id:A,checked:!r}))},m=()=>i(_e(l)),S=T=>{if(y)h(!1);else{const Q=T.target.closest("div").clientHeight;h(Q)}},L=()=>{t===""&&s("der "),t==="der "&&s("die "),t==="die "&&s("das "),t==="das "&&s("")},N=T=>{const{_id:Q}=j;i(Fe(l)),T.currentTarget.id!=="active-element"&&i(Z({_id:Q,activeEl:l._id}))};return n.jsxs(Ue,{id:A===C._id?"active-element":null,onClick:N,liColor:w,children:[n.jsxs(J,{$h:"100%",$p:"0",$fd:"column",children:[n.jsxs(Oe,{$hovered:a,children:[n.jsx("input",{type:"checkbox",name:"favorite",checked:a,onChange:c}),n.jsx(Re,{size:"20px"})]}),n.jsxs(Pe,{$hovered:r,children:[n.jsx("input",{type:"checkbox",name:"checked",checked:r,onChange:o}),n.jsx(Se,{size:"15px"})]}),y&&b===u+1&&n.jsx(be,{onClick:k,children:n.jsx(Te,{size:"16px"})})]}),y&&n.jsx(Ae,{el:l,article:t,isForm:y,setIsForm:h}),!y&&n.jsx(ke,{el:l,sortByDate:x,setSortByDate:p,setLiColor:g}),n.jsxs(J,{$h:"100%",$p:"0",$fd:"column",children:[n.jsx(Ge,{$hovered:e,onClick:m,children:n.jsx(Be,{size:"16px"})}),y&&n.jsx(ae,{onClick:L,children:n.jsx(Le,{size:"18px"})}),n.jsx(ae,{onClick:S,children:n.jsx(We,{size:"15px"})})]})]})};ye.propTypes={el:d.object,index:d.string,length:d.string,sortByDate:d.bool,setSortByDate:d.func,translateAll:d.func,liColor:d.string,setLiColor:d.func};const Je=$.ul`
  width: 100%;
  list-style: none;
`,{white:et}=W.colors,tt=()=>{const l=K(),{user:u}=q(),{activeCluster:b}=_(),{allElements:x,elementTrash:p,elementFilter:k}=O(),[w,g]=E.useState(et);let{elementSelect:i}=O();i=i||[];const[j,v]=E.useState(!1);E.useEffect(()=>{l(ue())},[l]),E.useEffect(()=>{const a=document.getElementById("active-element");(()=>{a==null||a.scrollIntoView({block:"center",behavior:"smooth"})})()},[]);const C=x.filter(a=>a.cluster===(b==null?void 0:b._id)).sort((a,r)=>a.createdAt.localeCompare(r.createdAt)),h=(()=>{const a=p.map(r=>r._id);return i.includes("trash")?C.filter(r=>a.includes(r._id)):C})().filter(({element:a,caption:r,favorite:e,checked:t})=>{const s=a.toLowerCase().replace("·","").includes(k)||a.toLowerCase().includes(k)||r.toLowerCase().includes(k),c=i.includes("favorite")?s&&e===!0:s;return i.some(o=>["checked","unchecked"].includes(o))?i.includes("checked")?c&&t===!0:c&&t===!1:c}).sort(j?(a,r)=>r.createdAt.localeCompare(a.createdAt):(a,r)=>a.createdAt.localeCompare(r.createdAt)),A=async()=>{const a=u.lang;let r=0;await h.forEach(async e=>{if(r>1)return;const{_id:t,element:s}=e;if(!s.startsWith("[")||a!==e.lang){const c={from:b.lang,to:a},o=await de(s,c);l(G({_id:t,lang:a,caption:o})),r=r+1}})};return n.jsxs(Je,{children:[h.map((a,r,e)=>n.jsx(ye,{el:a,index:r,length:e.length,sortByDate:j,setSortByDate:v,translateAll:A,liColor:w,setLiColor:g},a._id)),n.jsx(me,{filtredElements:h,setLiColor:g})]})},{s:pe,m:st}=W.indents,ct=()=>n.jsx(J,{$p:`0 ${st} ${pe} ${pe}`,children:n.jsx(tt,{})});export{ct as default};
