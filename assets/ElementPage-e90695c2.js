...
`,At=A.audio`
  ${Ce}
`,Ee=({el:t,sortByDate:l,setSortByDate:m,setLiColor:d})=>{const c=W(),{user:p}=D(),{activeCluster:f}=I(),{element:h,caption:i}=t,v="$*@",b=(n,e)=>{let u="";return e?(n.trim().endsWith(".")||n.trim().endsWith("!")||n.trim().endsWith("?")||n.endsWith('"')?u=n.trim().replaceAll(",`",";").replaceAll(" `",`${e} `).replaceAll("Mr.","mister").replaceAll("Ms.","miss").replaceAll("Mrs.","missis").replaceAll("...",`__${e}`).replaceAll(".",`.${e}`).replaceAll(",",`,${e}`).replaceAll("!",`!${e}`).replaceAll("?",`?${e}`).replaceAll(": ",`:${e} `).replaceAll(`0.${e}`,"0.").replaceAll(`1.${e}`,"1.").replaceAll(`2.${e}`,"2.").replaceAll(`3.${e}`,"3.").replaceAll(`4.${e}`,"4.").replaceAll(`5.${e}`,"5.").replaceAll(`6.${e}`,"6.").replaceAll(`7.${e}`,"7.").replaceAll(`8.${e}`,"8.").replaceAll(`9.${e}`,"9."):u=n.trim()+e,u.includes("[")?u.substring(0,u.indexOf("["))+e:u):n},g=n=>{const e=Y({setLiColor:d,divider:v,text:b(h,v),lang:f.lang,rate:f.rate});n.target.blur(),e&&F.error(e)},k=n=>{const e=Y({setLiColor:d,divider:v,text:b(i,v),lang:t.lang,rate:p.rate});n.target.blur(),e&&F.error(e)},$=n=>{m(!l),l?F.success("Below is Recent"):F.success("Above is Recent"),n.stopPropagation()},w=n=>{const{_id:e}=f;c($e(t)),n.currentTarget.closest("li").id!=="active-element"&&c(te({_id:e,activeEl:t._id}))},C=i.endsWith("mp3"),E=!C&&i.startsWith("http"),a=!C&&!E;return r.jsxs(gt,{onClick:w,children:[r.jsx(fe,{onClick:g,children:h}),r.jsx($t,{onClick:$}),C&&r.jsx(At,{controls:!0,src:ae(i)}),E&&r.jsx(jt,{src:ae(i)}),a&&r.jsx(fe,{onClick:k,children:i})]})};Ee.propTypes={el:x.object,sortByDate:x.bool,setSortByDate:x.func,$active:x.bool,$hovered:x.bool,setLiColor:x.func};const Se=({el:t,article:l,isForm:m,setIsForm:d})=>{const c=W(),{user:p}=D(),{activeCluster:f}=I(),{_id:h,element:i,caption:v}=t,b=m+24,{register:g,watch:k,setValue:$,handleSubmit:w,setFocus:C}=Je({mode:"onBlur",defaultValues:{element:i,caption:v}});T.useEffect(()=>{C("element"),l&&i.trim().startsWith("der")?$("element",l+i.replace("der","").trim()+", "):l&&i.trim().startsWith("die")?$("element",l+i.replace("die","").trim()+", "):l&&i.trim().startsWith("das")?$("element",l+i.replace("das","").trim()+", "):l?$("element",l+i+", "):$("element",l+i)},[l,i,C,$]),T.useEffect(()=>{const n=async e=>{e.key==="+"&&(e.preventDefault(),await a(),w(E)()),e.key==="Enter"&&(e.preventDefault(),w(E)()),e.key==="Escape"&&d(!1)};return addEventListener("keydown",n),()=>{removeEventListener("keydown",n)}},[]);const E=n=>{const e=p.lang;let u=n.element.split(/\s+/).join(" ").trim(),s=n.caption.trim();u.endsWith(",")&&(u=u.substring(0,u.length-1)),u.includes("·")&&(u=u.replaceAll(" ·",",").replaceAll("· ",", ")),s.endsWith(",")&&(s=s.substring(0,s.length-1)),c(Z({_id:h,lang:e,element:u,caption:s})).then(c(xe())),d(!1)},a=async()=>{let n=k("element");const e=[".","!","?"].includes(n.at(n.length-1)),u=!e&&n.split(/\s+/);["der","die","das"].includes(u[0])&&(n=u[1]);const s=!e&&n.split(",");s.length===3&&(n=s[0]+",");const o={from:f.lang,to:p.lang},y=await re(n,o);$("caption",y)};return r.jsxs(bt,{onSubmit:w(E),children:[r.jsx(me,{...g("element"),style:{height:b}}),r.jsxs(xt,{children:[r.jsx(vt,{children:r.jsx(ze,{size:"16px"})}),r.jsx(yt,{type:"button",onClick:()=>d(b),children:r.jsx(De,{size:"16px"})}),r.jsx(we,{type:"button",onClick:a,children:r.jsx(Ve,{size:"16px"})})]}),r.jsx(me,{...g("caption"),style:{height:b}})]})};Se.propTypes={el:x.object,article:x.string,isForm:x.oneOfType([x.bool,x.number]),setIsForm:x.func};const Te=({el:t,index:l,length:m,sortByDate:d,setSortByDate:c,translateAll:p,liColor:f,setLiColor:h})=>{const i=W(),{elementTrash:v,activeElement:b}=L(),[g,k]=T.useState(!1),{_id:$,favorite:w,checked:C}=t,E=v.find(S=>S._id===$),[a,n]=T.useState(""),e=()=>{i(Z({_id:$,favorite:!w}))},u=()=>{i(Z({_id:$,checked:!C}))},s=()=>i(Pe(t)),o=S=>{if(g)k(!1);else{const _=S.target.closest("div").clientHeight;k(_)}},y=()=>{a===""&&n("der "),a==="der "&&n("die "),a==="die "&&n("das "),a==="das "&&n("")},R=$===(b==null?void 0:b._id);return r.jsxs(pt,{id:R?"active-element":null,licolor:f,children:[r.jsxs(ne,{$h:"100%",$p:"0",$fd:"column",children:[r.jsxs(ht,{$hovered:w,children:[r.jsx("input",{type:"checkbox",name:"favorite",checked:w,onChange:e}),r.jsx(qe,{size:"20px"})]}),r.jsxs(mt,{$hovered:C,children:[r.jsx("input",{type:"checkbox",name:"checked",checked:C,onChange:u}),r.jsx(Me,{size:"15px"})]}),g&&m===l+1&&r.jsx(we,{onClick:p,children:r.jsx(Oe,{size:"16px"})})]}),g&&r.jsx(Se,{el:t,article:a,isForm:g,setIsForm:k}),!g&&r.jsx(Ee,{el:t,sortByDate:d,setSortByDate:c,setLiColor:h}),r.jsxs(ne,{$h:"100%",$p:"0",$fd:"column",children:[r.jsx(ft,{$hovered:E,onClick:s,children:r.jsx(Ue,{size:"16px"})}),g&&r.jsx(he,{onClick:y,children:r.jsx(Ye,{size:"18px"})}),r.jsx(he,{onClick:o,children:r.jsx(He,{size:"15px"})})]})]})};Te.propTypes={el:x.object,index:x.number,length:x.number,sortByDate:x.bool,setSortByDate:x.func,translateAll:x.func,liColor:x.string,setLiColor:x.func};const kt=A.ul`
  width: 100%;
  list-style: none;
`,{white:wt}=B.colors,Ct=()=>{const t=W(),{ref:l,inView:m,entry:d}=rt({initialInView:!0,rootMargin:"0px 0px -30px 0px"}),{user:c}=D(),{activeCluster:p}=I(),{allElements:f,elementTrash:h,elementFilter:i}=L(),[v,b]=T.useState(wt);let{elementSelect:g}=L();g=g||[];const[k,$]=T.useState(!1),[w,C]=T.useState(!0);T.useEffect(()=>{p&&t(xe({cluster:p._id})).unwrap().then(({result:s})=>{if(!p.activeEl)return;const o=s.elements.find(({_id:y})=>y===p.activeEl);t($e(o))}).then(()=>{const s=document.getElementById("active-element");(()=>{s==null||s.scrollIntoView({block:"center",behavior:"smooth"})})(),C(!1)})},[]);const E=f.filter(s=>s.cluster===(p==null?void 0:p._id)).sort((s,o)=>s.createdAt.localeCompare(o.createdAt)),n=(()=>{const s=h.map(o=>o._id);return g.includes("trash")?E.filter(o=>s.includes(o._id)):E})().filter(({element:s,caption:o,favorite:y,checked:R})=>{const S=s.toLowerCase().replace("·","").includes(i)||s.toLowerCase().includes(i)||o.toLowerCase().includes(i),_=()=>g.some(z=>["favorite","unfavorite"].includes(z))?g.includes("favorite")?S&&y===!0:S&&y===!1:S;return(()=>g.some(z=>["checked","unchecked"].includes(z))?g.includes("checked")?_()&&R===!0:_()&&R===!1:_())()}).sort(k?(s,o)=>o.createdAt.localeCompare(s.createdAt):(s,o)=>s.createdAt.localeCompare(o.createdAt)),e=async()=>{const s=c.lang;let o=0;await n.forEach(async y=>{if(o>1)return;const{_id:R,element:S}=y;if(!S.startsWith("[")||s!==y.lang){const _={from:p.lang,to:s},O=await re(S,_);t(Z({_id:R,lang:s,caption:O})),o=o+1}})},u=window.innerHeight<(d==null?void 0:d.target.getBoundingClientRect().y)+(d==null?void 0:d.target.getBoundingClientRect().height)*1.5;return r.jsxs(r.Fragment,{children:[r.jsxs(kt,{children:[n.map((s,o,y)=>r.jsx(Te,{el:s,index:o,length:y.length,sortByDate:k,setSortByDate:$,translateAll:e,liColor:v,setLiColor:b},s._id)),r.jsxs("div",{ref:l,children:[r.jsx(ye,{filtredElements:n,setLiColor:b}),(!m||!u)&&r.jsx(ut,{})]})]}),w&&r.jsx(Ge,{})]})},{s:ge,m:Et}=B.indents,Ft=()=>r.jsx(ne,{$p:`0 ${Et} ${ge} ${ge}`,children:r.jsx(Ct,{})});export{Ft as default};
